...
//function RegInstitute() {
  ...
  const handlechange = (e) => {
   ...
   const handleSubmit = (e) => {
    ...
    const [insttype, setinsttype] = useState(["Select", "Central University", "State University", "Deemed University","Private Institute" , "Affiliated College", "Autonomous College"])
    const Add1 = insttype.map(Add1 => Add1)
    const handleInstType = (e) => console.log((insttype[e.target.value]))

    const [startmon, setstartmon] = useState(["Select", "January", "February", "March", "April", "May", "June", "July" , "August", "September", "October" , "November", "December"])
